...
# tx_flange_flangerot45[:3,:3] = st.Rotation.from_euler('z', [np.pi]).as_matrix()

# tx_flange_tip = tx_flange_flangerot45
# tx_tip_flange = np.linalg.inv(tx_flange_flangerot45)
...
class FrankaInterpolationController(mp.Process):
    ...
    def schedule_waypoint(self, pose, target_time):
        ...
        # print(f"schedule_waypoint: {message}")
        self.input_queue.put(message)
